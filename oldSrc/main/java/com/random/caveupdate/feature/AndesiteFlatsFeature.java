...
public class AndesiteFlatsFeature extends Feature<DefaultFeatureConfig> {

	public AndesiteFlatsFeature(Codec<DefaultFeatureConfig> configCodec) {
		super(configCodec);
		                  ...
		                  for(ac = 0; ac < 16; ++ac) {
		                     for(ad = 0; ad < 8; ++ad) {
		                        ...
		                        if (bl2 && (ad < 4 || random.nextInt(2) != 0) && serverWorldAccess.getBlockState(mutPos.add(ab, ad, ac)).getBlock() == Blocks.STONE) {
		                           serverWorldAccess.setBlockState(mutPos.add(ab, ad, ac), Blocks.ANDESITE.getDefaultState(), 2);
		                        }
		                     }
		                  }
		               }
